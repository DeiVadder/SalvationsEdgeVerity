...
public:
    ...
    Q_INVOKABLE void calculateSteps(SymbolTypes innerStatue1, SymbolTypes innerStatue2, SymbolTypes innerStatue3,
                                    SymbolTypes outerStatue1, SymbolTypes outerStatue2, SymbolTypes outerStatue3);
    ...
    Q_INVOKABLE bool checkIsValid(SymbolTypes innerStatue1, SymbolTypes innerStatue2, SymbolTypes innerStatue3,
                    SymbolTypes outerStatue1, SymbolTypes outerStatue2, SymbolTypes outerStatue3);
...
private:
    ...
    bool isFinished(const QVector<QVector<SymbolTypes>> &start, const QVector<QVector<SymbolTypes>> &ziel);
