        ...
        Flickable {
            ...
            Text {
                ...
                text: {
                    ...
                    var insideBody = qsTr("Pick each player's own 2D symbol the same way. In Challenge Mode, enter the outside team's 3 escape shapes (called out verbally) so the inside solution targets those instead of the default split. Detailed Mode lets you enter what's actually on each player's wall for a real LFG or Fast cleanse sequence - UNVERIFIED against real gameplay, sanity-check it before trusting it in a live run. Fast isn't offered in Challenge Mode.")
